package com.example.anter.numberscanner.scanner;
...
import com.example.anter.numberscanner.R;
import com.example.anter.numberscanner.scanner.camera.CameraManager;
import com.example.anter.numberscanner.scanner.decode.CaptureActivityHandler;
import com.example.anter.numberscanner.scanner.decode.DecodeManager;
import com.example.anter.numberscanner.scanner.decode.InactivityTimer;
import com.example.anter.numberscanner.scanner.tess.TesseractCallback;
import com.example.anter.numberscanner.scanner.tess.TesseractThread;
import com.example.anter.numberscanner.scanner.utils.Tools;
import com.example.anter.numberscanner.scanner.view.ImageDialog;
import com.example.anter.numberscanner.scanner.view.ScannerFinderView;
...
public class ScannerActivity extends Activity implements Callback, Camera.PictureCallback, Camera.ShutterCallback {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == 1 && TextUtils.equals(permissions[0], Manifest.permission.CAMERA) && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            CameraManager.init();
            initCamera();
        }
    }
    ...
    private void handleResult(Result result) {
        if (TextUtils.isEmpty(result.getText())) {
            ...
            if (switch1.isChecked()) {
                ...
                phoneSucceed(result.getText(), bmp);
            }
        }
    }
